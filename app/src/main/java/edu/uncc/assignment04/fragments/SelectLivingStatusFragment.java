...
public class SelectLivingStatusFragment extends Fragment {
    ...
    public SelectLivingStatusFragmentListener mListener;
    ...
    public static SelectLivingStatusFragment newInstance(Response param1) {
        ...
        view.findViewById(R.id.buttonSubmit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedButton == null) {
                    ...
                    mListener.LivingStatusFragmentListener(radioText);
                }
            }
        });
    ...
    public interface SelectLivingStatusFragmentListener {
        void LivingStatusFragmentListener(String livingStatus);
    }
