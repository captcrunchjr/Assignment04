...
public class SelectEducationFragment extends Fragment {
    ...
    EducationFragmentListener mListener;
    ...
    public static SelectEducationFragment newInstance(Response param1) {
        ...
        view.findViewById(R.id.buttonSubmit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedButton == null) {
                    ...
                    mListener.EducationFragmentListener(radioText);
                }
            }
        });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mListener = (EducationFragmentListener) context;
    }

    //define interface
    public interface EducationFragmentListener {
        void EducationFragmentListener(String educationLevel);
    }
}